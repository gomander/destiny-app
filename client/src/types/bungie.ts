...
export enum BungieItemSubType {
  ...
  'class armor' = 30,
  'bow' = 31,
  'dummy repeatable bounty' = 32,
  'glaive' = 33
}

export enum BungieRarity {
  'unknown' = 0,
  'currency' = 1,
  'common' = 2,
  'uncommon' = 3,
...
export enum RaidTitleTriumphCategories {
  LastWish = 1486062207,
  GardenOfSalvation = 1827854727,
  DeepStoneCrypt = 2960810718,
  VaultOfGlass = 3734352323,
